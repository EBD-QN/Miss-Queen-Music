...
class Config(object):
    ...
    BLACK_IMG = getenv("BLACK_IMG", "https://telegra.ph/file/df04d52c2c5c37f9e285f.jpg")        # black image for progress
    BOT_NAME = getenv("BOT_NAME", "\x40\x4d\x75\x73\x69\x63\x5f\x48\x65\x6c\x6c\x42\x6f\x74")   # dont put fancy texts here.
    BOT_PIC = getenv("BOT_PIC", "https://telegra.ph/file/df04d52c2c5c37f9e285f.jpg")           # put direct link to image here
